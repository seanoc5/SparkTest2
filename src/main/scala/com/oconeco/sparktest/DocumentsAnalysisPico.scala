...
//
//@Command(name = "DocAnalysis", mixinStandardHelpOptions = true, version = Array("DocumentAnalysis app version 0.1.1"),
//  description = Array("Analyze documents from postgres database."))
